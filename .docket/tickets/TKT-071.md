...
## Acceptance Criteria
- [ ] `ship agent:start --task "description" --id T01` creates the worktree, branch, and TASK.md. The worktree is functional (can run `go build` from it). `.worktrees/` is gitignored.
