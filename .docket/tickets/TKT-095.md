...
updated_at: "2026-03-16T13:40:20Z"
created_by: human:Leo Audibert
write_hash: 893d70dc3a0f220592831384555c0f8c18a57abe2e109dc27d0a550010aba0e4
---
...
## Acceptance Criteria
- [x] `container.Flags.Enabled(ctx, "my_flag")` returns correct value based on DB. Cache prevents repeated DB reads. Rollout is deterministic (same user, same result). Toggle in admin panel takes effect within cache TTL. `ship verify` passes. : go test ./modules/flags ./modules/admin ./app/foundation
