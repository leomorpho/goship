...
## Acceptance Criteria
- [ ] `ship doctor` warns on files exceeding thresholds. Output includes the file path and line count. Excluded files are not flagged. `--json` output includes these as issues.
