...
updated_at: "2026-03-16T13:35:12Z"
created_by: human:Leo Audibert
write_hash: afc0bb009da01bc806a68e63df7ced577258b2dc3fe56eb3ec3a6592112c23d2
---
...
## Acceptance Criteria
- [x] `ship make:migration AddSoftDeleteToOrders --table orders` generates correct SQL. Doctor warns on unfiltered queries. Framework helpers compile and have tests. Admin panel shows trash view (if admin module is installed). : go test ./tools/cli/ship/internal/policies ./modules/admin ./framework/softdelete ./tools/cli/ship/internal/commands
