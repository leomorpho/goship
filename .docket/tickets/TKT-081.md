...
## Acceptance Criteria
- [ ] `GET /health/ready` returns full JSON with all checker results. Returns 503 if DB is unreachable. Returns 200 with correct latencies when all systems are healthy.
