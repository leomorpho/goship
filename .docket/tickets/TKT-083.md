...
## Acceptance Criteria
- [ ] Each email template renders to valid HTML. `RenderEmail` returns non-empty HTML and text strings. The templates follow `docs/ui/convention.md` where applicable.
