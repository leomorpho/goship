...
updated_at: "2026-03-16T13:41:53Z"
created_by: human:Leo Audibert
write_hash: a8aaaf7d2e0bf894a1353bce0b18974753e753ca17c01e521fdf33d15a9225df
---
...
## Acceptance Criteria
- [x] A controller can stream SSE events in 5 lines of code. `Hub.Publish("post:42", html)` delivers to every open connection subscribed to `post:42`. Unsubscribed connections receive nothing. Client disconnect cleanup works (no goroutine leak). The shared counter example works in a browser. : go test ./framework/sse ./app/web/controllers
