...
updated_at: "2026-03-16T13:42:10Z"
created_by: human:Leo Audibert
write_hash: fdf78f333f4a47bbfbb096f2f882e5721e6ff04e8cbda7fb0c027ccc93991379
---
...
## Acceptance Criteria
- [x] `api.OK(c, data)` sends correctly enveloped JSON. `IsAPIRequest` correctly detects API clients. Common error responses use the standard error format. `ship verify` passes. : go test ./framework/api ./tools/cli/ship/internal/policies
