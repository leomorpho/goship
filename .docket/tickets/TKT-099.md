...
## Acceptance Criteria
- [ ] `ship api:spec` outputs valid OpenAPI 3.0 JSON that passes validation (`npx @redocly/cli lint openapi.json`). All contract types with `// Route:` comments are included.
