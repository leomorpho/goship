...
## Acceptance Criteria
- [ ] `container.AI.Complete(ctx, ai.Request{Model: ai.ClaudeHaiku4, Messages: [...]})` returns a response. Streaming returns a channel of tokens. Structured output unmarshals correctly. Mock provider works for testing.
