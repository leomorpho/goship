...
## Acceptance Criteria
- [ ] `GET /dev/mail/welcome` renders the welcome email in the browser. Routes do not exist in production (verified by checking env guard). Index page lists all available previews.
