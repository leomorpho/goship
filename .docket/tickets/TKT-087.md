...
## Acceptance Criteria
- [ ] GitHub OAuth login flow works end-to-end: clicking "Continue with GitHub" redirects to GitHub, callback creates/links user, session is created, user lands on home. Account linking works (same email = same user). CSRF state validation prevents open redirect.
