...
write_hash: e8298cb42936543207c9e79ec724066f193babc6e7ed296709a74f850b3d17b2
---
...
## Acceptance Criteria
- [x] All exported components in `components/` and `layouts/` have `data-component` on their root element and the project compiles cleanly. : PATH="$(go env GOPATH)/bin:$PATH" make templ-gen; go test ./tools/cli/ship/internal/policies; go test ./...
