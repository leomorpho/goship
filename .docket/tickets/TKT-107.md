...
write_hash: 55af32304a973fd55acb0089fe86f18f62c1a3c7706aeb8566d7dafdacdeb08e
---
...
## Acceptance Criteria
- [x] Every exported templ function in `app/views/web/` has both `// Renders:` and `// Route(s):` comments. : go test ./...
