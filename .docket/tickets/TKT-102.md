...
## Acceptance Criteria
- [ ] `container.I18n.T(ctx, "auth.login.title")` returns the correct translation for the detected language. `Accept-Language: fr` header returns French strings. `ship i18n:missing` lists untranslated keys. `ship verify` passes.
