...
## Acceptance Criteria
- [ ] A test can make authenticated POST requests to the app in 5 lines. CSRF is handled automatically. `AssertStatus`, `AssertRedirectsTo`, `AssertContains` work correctly. `go test ./...` passes.
