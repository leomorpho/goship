...
Scope note:
- this workflow targets the **framework workspace**, not the minimal starter scaffold generated by default `ship new`.
- on the starter scaffold today, prefer `ship make:resource`, `ship make:model`, and `ship make:island`.
