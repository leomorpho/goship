...
- `ship db:promote [--json]` -> reports the manual SQLite-to-Postgres promotion plan from current runtime metadata; `--json` emits machine-readable plan output for agents/tooling
