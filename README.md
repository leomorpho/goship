...
⚠️ ⚠️ ⚠️ NOTE: the below docs are mostly for Pagoda, and some sections may not apply to GoShip. This is being actively fixed. Thanks for your patience! ❤️
...
PWABuilder was used to generate the native app wrappers. Some additional changes were added depending on the platform. See [the docs](https://docs.pwabuilder.com/#/builder/app-store) for more info.

### iOS

I added push notifications as shown in the original template that was eventually integrated into PWABuilder.
Go to the `src` directory and run `pod install`. To install pod, `brew install cocoapods` on macos.

Follow the Publishing steps in [here](https://docs.pwabuilder.com/#/builder/app-store) and complete the iOS shenanigans to get in flighttest and the app store. Warning, it requires a lot of work and some patience.
...
- [getzep/zep](): LLM
- [Pines Tailwind/Alpinejs library](https://devdojo.com/pines/docs/context-menu)
- [GoReplay](https://github.com/buger/goreplay): GoReplay is an open-source tool for capturing and replaying live HTTP traffic into a test environment in order to continuously test your system with real data. It can be used to increase confidence in code deployments, configuration changes and infrastructure changes.
- [nektos/act](https://github.com/nektos/act): run your github CI locally
- [nikoksr/notify](https://github.com/nikoksr/notify): A dead simple Go library for sending notifications to various messaging services. Can be used for critical messages to support team.
- [i18](https://github.com/eduardolat/goeasyi18n): also see [this reddit thread](https://www.reddit.com/r/golang/comments/177kek2/just_updated_my_go_i18n_library_looking_for/)
- [go-recipes](https://github.com/nikolaydubina/go-recipes)
- [free go-nats in prod](https://cloud.synadia.com/systems/2ZrWrtiTulqqNOFU3FpjYI5FaI8/welcome)

For SSE, see https://github.com/tmaxmax/go-sse
For emailing, see Postmark.
For mailing, see https://github.com/wneessen/go-mail or https://resend.com/home
For transactional email HTML creation see https://github.com/matcornic/hermes?utm_campaign=awesomego&utm_medium=referral&utm_source=awesomego
See [https://windstatic.com/](https://windstatic.com/) for Tailwind/AlpineJS components to reuse.

# Marketing
- Find more than just a pretty face; this app lays the groundwork for strong, healthy relationships built on true understanding.
- Our app guides you past fleeting one-night stands to discover profound connections and relationships built to last.
- Move beyond awkward blind dates and short-lived flings towards the fulfilling, deep relationships you've always wanted.
- Transform your dating life: From quick flings and awkward dates to meaningful, substantial relationships.
- Escalate your dating experience; move from fleeting attractions to deep, meaningful connections that last.
- Bid goodbye to shallow encounters and one-night stands; welcome the era of profound, enduring relationships.


- Get past the awkward blind dates and the one night stands that don't progress to the deep relationships you yearn for. 
- This dating app provides you with the foundations of a strong healthy relationship, where you get to know the person without resting only on good-look heuristics and small talk skills.

## Test emails manually
`swaks --to recipient@example.com --from sender@example.com --server localhost:1025 --data "Subject: Test Email\n\nThis is a test email from Swaks."`
