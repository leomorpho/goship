import"./ThemeToggle-IHki7fMi.js";class n extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.template=document.createElement("template"),this.template.innerHTML=n.template(),this.shadowRoot.append(this.template.content.cloneNode(!0))}connectedCallback(){this.setAttribute("role","status"),this.setAttribute("aria-live","polite"),this.position=this.getAttribute("position")||"top-center",this.arrangeToastPosition(this.position)}static get observedAttributes(){return["position"]}attributeChangedCallback(t,e,o){t==="position"&&(this.position=o,this.arrangeToastPosition(this.position))}arrangeToastPosition(t){const e=t.includes("top"),o={top:e&&0,bottom:!e&&0},s=t.includes("center")?"center":t.includes("right")?"flex-end":"flex-start",i=e?1:-1,a=e?"column-reverse":"column",h=window.getComputedStyle(document.querySelector("html")).getPropertyValue("scrollbar-gutter");this.style.setProperty("--wc-toast-factor",i),this.style.setProperty("--wc-toast-position",s),this.style.setProperty("--wc-toast-direction",a);const r=this.shadowRoot.querySelector(".wc-toast-container");r.style.top=o.top,r.style.bottom=o.bottom,r.style.right=h.includes("stable")&&"4px",r.style.justifyContent=s}static template(){return`
    <style>
      :host {
        --wc-toast-factor: 1;
    ...
    `}}customElements.define("wc-toast-content",d);class m extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.template=document.createElement("template"),this.template.innerHTML=m.template(),this.shadowRoot.append(this.template.content.cloneNode(!0))}static template(){return`
    <style>
      :host {
        width: 20px;
        opacity: 1;
    ...
    `}}customElements.define("wc-toast-close-button",m);
//# sourceMappingURL=NotificationPermissions-CvhOALsm.js.map
