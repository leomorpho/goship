...
func PlatformPermissionButton(platformName domain.NotificationPlatform, permissionGranted bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		var templ_7745c5c3_Var3 = []any{"p-2 m-2 text-sm font-medium focus:outline-none rounded-full",
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `goship/views/web/components/permissions.templ`, Line: 1, Col: 0}
		}
