...
func EditPhonePage(page *controller.Page) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if data, ok := page.Data.(*types.PhoneNumber); ok {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/goship/views/pages/phone.templ`, Line: 24, Col: 84}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/goship/views/pages/phone.templ`, Line: 43, Col: 67}
			}
...
func PhoneVerificationField(page *controller.Page) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if form, ok := page.Form.(*types.PhoneNumberVerification); ok {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/goship/views/pages/phone.templ`, Line: 66, Col: 83}
			}
			...
			if data, ok := page.Data.(*types.SmsVerificationCodeInfo); ok {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/goship/views/pages/phone.templ`, Line: 72, Col: 168}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/goship/views/pages/phone.templ`, Line: 1, Col: 0}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/goship/views/pages/phone.templ`, Line: 88, Col: 36}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/goship/views/pages/phone.templ`, Line: 102, Col: 70}
			}
