...
func PrintMakeHelp(w io.Writer) {
	...
	fmt.Fprintln(w, "  ship make:controller <Name|NameController> [--actions index,show,create,update,destroy] [--auth public|auth] [--wire]                    Generate a controller with optional route wiring (framework workspace only for now)")
