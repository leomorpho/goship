...
func PrintRootHelp(w io.Writer) {
	...
	fmt.Fprintln(w, "  ship i18n:<init|scan|instrument|migrate|normalize|missing|unused>  (or ship i18n for help)")
	...
	fmt.Fprintln(w, "  ship run:command <name> [-- <args...>]")
	...
	fmt.Fprintln(w, "  ship make:<scaffold|controller|resource|model|factory|locale|event|schedule|command|module>  (or ship make for help)")
	...
	fmt.Fprintln(w, "  ship i18n:init")
	fmt.Fprintln(w, "  ship i18n:scan --format json --limit 20")
	fmt.Fprintln(w, "  ship i18n:instrument --apply")
	fmt.Fprintln(w, "  ship i18n:migrate")
	...
	fmt.Fprintln(w, "  ship run:command send:test-email -- --dry-run")
	...
	fmt.Fprintln(w, "  ship make:factory User")
	fmt.Fprintln(w, "  ship make:locale fr")
	fmt.Fprintln(w, "  ship make:event UserLoggedIn")
	fmt.Fprintln(w, "  ship make:schedule DailyReport --cron \"0 9 * * *\"")
	fmt.Fprintln(w, "  ship make:command BackfillUserStats")
...
func PrintMakeHelp(w io.Writer) {
	...
	fmt.Fprintln(w, "  ship make:factory <Name>")
	fmt.Fprintln(w, "  ship make:locale <code>")
	fmt.Fprintln(w, "  ship make:event <TypeName> [--force]")
	fmt.Fprintln(w, "  ship make:schedule <Name> --cron \"<expr>\"")
	fmt.Fprintln(w, "  ship make:command <Name>")
